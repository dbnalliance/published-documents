...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:pattern>
        <sch:rule context="cbc:CustomizationID[1]">            
            <sch:assert test="(. = 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##DBNAlliance-1.0-data-Core')">cbc:CustomizationID[1] must equal 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##DBNAlliance-1.0-data-Core'</sch:assert>                
        </sch:rule>
    </sch:pattern>
